...
while True:
    ...
    while True:
        ...
        try:
            selected_recipe_idx = int(selected_recipe_idx)
            if 1 <= selected_recipe_idx <= len(available_recipes):
                selected_recipe = available_recipes[selected_recipe_idx - 1]
